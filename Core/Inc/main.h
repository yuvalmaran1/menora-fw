...
/* Private defines -----------------------------------------------------------*/
#define TSC_LIGHT_Pin GPIO_PIN_0
#define TSC_LIGHT_GPIO_Port GPIOA
#define TSC_MUSIC_Pin GPIO_PIN_1
#define TSC_MUSIC_GPIO_Port GPIOA
#define TSC_MODE_Pin GPIO_PIN_2
