...
int main(void)
{
  ...
  MENORA_INIT_CONFIG_st menora_cfg = {
      ...
      .tsc = &htsc,
      .tsc_light_btn_channel_io = TSC_GROUP1_IO1,
      .tsc_music_btn_channel_io = TSC_GROUP1_IO2,
      .tsc_mode_btn_channel_io = TSC_GROUP1_IO3,
      .tsc_btn_group_index = TSC_GROUP1_IDX,
      .tsc_btn_sampling_io = TSC_GROUP1_IO4
  };
  /* USER CODE END 1 */
